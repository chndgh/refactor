package com.company.project.client.quartz.taobao.category;
...
@Service
public class TaobaoCateDetail extends AbstractAppMaster { // QuartzLocalAppMaster { //AbstractAppMaster {
    ...
    private double meetloopstoppercent = 0.8;
